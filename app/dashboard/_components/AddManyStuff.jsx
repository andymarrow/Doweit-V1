...
export default function ADDManyStuff() {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center bg-gray-100 rounded-lg mt-2 p-2">
            <h1 className="text-4xl font-bold mb-8">Add Many Stuff</h1>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-6xl">
                {cardData.map((card, index) => (
                    <div
                        key={index}
                        className="bg-white shadow-md rounded-lg p-6 flex flex-col items-center justify-between text-center hover:shadow-xl transition-shadow duration-300"
                    >
